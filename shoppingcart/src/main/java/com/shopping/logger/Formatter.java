...
public class Formatter implements IFormatter {
    ...
    public String format(String id, String msg) {
        return msgFormat.format(((Object) (new Object[] {
            id, msg
        })));
    }

    protected String format(String id, String method, String msg) {
        return msgMethodFormat.format(((Object) (new Object[] {
            id,
            method, msg
        })));
    }
    ...
    protected String format(String entity, String userId, String timestamp,
        ...
        return msgAuditFormat.format((Object) (new Object[] {
            entity,
            userId, timestamp, action, before, after, result
        }));
